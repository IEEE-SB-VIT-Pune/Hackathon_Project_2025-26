...
const Calendar = () => {
  ...
  const handleFilterChange = (category, value) => {
    setFilters((prev) => {
      if (category === "reset")
        return { status: [...ALL_STATUSES], type: [...ALL_TYPES] };
    ...
    <div className="calendar-page">
      ...
      <div className="calendar-top-bar">
        ...
        <div className="view-mode-toggles">
          ...
          >
            <Icon name="calendar" size={18} className="inline mr-2" /> Month
          </button>
          <button
            className={`view-btn ${viewMode === "list" ? "active" : ""}`}
            onClick={() => setViewMode("list")}
          >
            <Icon name="file" size={18} className="inline mr-2" /> List
          </button>
        </div>
      ...
      {!error && events.length === 0 && (
        <div style={{ textAlign: "center", padding: "2rem", color: "#6b7280" }}>
          ...
          {showAll ? (
            ...
            <p>
              Register for a hackathon to see its schedule here, or switch to{" "}
