...
const gateways = [
  ...
  },
  {
    ...
    to: "/judge/hackathons",
    accent: COLORS.secondary.orange,
    bg: "#fffbeb",
  },
  {
    iconName: "settings",
      ...
      <section className="home-hero">
        <div className="hero-content">
          <div className="hero-badge">
            <Icon name="rocket" size={20} className="text-primary-dark" />
          ...
          <p className="hero-subtitle">
            One platform to host, manage, and participate in hackathons. From
            team formation to judging — everything in one place.
          </p>
