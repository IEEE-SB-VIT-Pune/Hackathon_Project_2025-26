...
/* ─── Small stat widget ─────────────────────────────── */
const StatBox = ({ label, value, iconName, color }) => (
  <div
    style={{
      background: "#fff",
      borderRadius: "14px",
  ...
  >
    ...
    >
      <Icon name={iconName} size={24} className="text-primary-dark" />
    </div>
    <div>
      <div
        style={{
...
const HackCard = ({ h, navigate }) => {
  ...
  return (
    ...
    >
      ...
      >
        {[
          { label: "Teams", value: h.teamCount ?? 0, iconName: "users" },
          {
            label: "Submissions",
            value: h.submissionCount ?? 0,
            iconName: "file",
          },
          { label: "Max Teams", value: h.maxTeams ?? "∞", iconName: "trophy" },
          ...
          <div key={label} style={{ textAlign: "center" }}>
            ...
            >
              <Icon name={iconName} size={20} className="text-primary-dark" />
              {value}
            </div>
            <div
              style={{
      ...
      <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
        ...
        >
          <Icon name="file" size={16} /> View Details
        </button>
        ...
        <button
          ...
          onMouseOver={(e) =>
            (e.currentTarget.style.background = `${COLORS.primary.light}25`)
          }
          onMouseOut={(e) =>
            (e.currentTarget.style.background = `${COLORS.primary.light}15`)
          }
        >
...
function OrganizerDashboard() {
  ...
  useEffect(() => {
    ...
    getOrganizerHackathons()
      .then((res) => {
        if (isMounted) setHackathons(res.data?.data || []);
      })
      .catch((err) => {
        if (isMounted)
      ...
      <div className="admin-layout">
        ...
        <main className="admin-main">
          ...
          >
            ...
            >
              <Icon name="refresh-ccw" size={18} /> Retry
            </button>
          </div>
        </main>
      </div>
        ...
        <div className="admin-container">
          ...
          >
            <div>
              ...
              <p style={{ margin: 0, opacity: 0.8, fontSize: "1.05rem" }}>
                View stats, edit events, and manage submissions.
              </p>
            </div>
            <button
              style={{
          ...
          >
            <StatBox
              ...
              iconName="folder"
              color={`${COLORS.primary.dark}15`}
            />
            <StatBox
              label="Active / Open"
              value={activeHackathons}
              iconName="zap"
              color={`${COLORS.primary.light}15`}
            />
            <StatBox
            ...
            {["all", "open", "ongoing", "completed", "cancelled"].map((s) => (
              <button
                ...
                style={{
                  ...
                  border: "1.5px solid",
                  borderColor:
                    statusFilter === s ? COLORS.primary.light : "#e5e7eb",
                  background:
                    statusFilter === s ? COLORS.primary.light : "#fff",
          ...
          {displayed.length === 0 ? (
            ...
            >
              ...
              {totalHackathons === 0 ? (
                <p style={{ fontSize: "1.1rem", fontWeight: "500" }}>
                  ...
                  <strong>"+ Host a Hackathon"</strong> to get started!
                </p>
              ) : (
            ...
            >
              {displayed.map((h) => (
                <HackCard key={h._id} h={h} navigate={navigate} />
              ))}
            </div>
          )}
        </div>
