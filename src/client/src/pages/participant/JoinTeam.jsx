...
const JoinTeam = () => {
  ...
  const handleApply = async (teamId) => {
    try {
      ...
      alert(
        "✅ Request Sent Successfully! The team leader will review your application.",
      );
    } catch (error) {
      const msg = error.response?.data?.message || "Request failed";
      alert(
        msg.includes("already")
          ? "⚠️ You have already requested this team or are currently in a team."
          : `❌ Error: ${msg}`,
      );
    } finally {
      setRequesting(null);
        ...
        >
          <div style={{ textAlign: "center", marginBottom: "30px" }}>
            ...
            <p style={{ margin: 0, color: "#6b7280", fontSize: "1.1rem" }}>
              Let's introduce yourself to potential teammates.
            </p>
          </div>
            ...
            <div style={{ display: "flex", gap: "15px", marginTop: "10px" }}>
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: "bold",
                  cursor: "pointer",
                  boxShadow: "0 4px 6px rgba(14, 40, 114, 0.2)",
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            >
              Discover open teams looking for{" "}
              <strong>{participantData.skills || "talented members"}</strong>.
            </p>
          </div>
                ...
                >
                  ...
                  >
                    {team.projectDescription ||
                      "Looking for passionate teammates to build an innovative solution. Let's create something amazing together!"}
                  </p>
