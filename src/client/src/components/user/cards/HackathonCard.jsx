      ...
      <div className="card-content">
        ...
        <div className="info-grid">
          <div className="info-item">
            <Icon name="users" size={16} className="inline mr-1" /> Team Size:{" "}
            {hackathon.teamSize}
          </div>
          <div className="info-item">
            <Icon name="location" size={16} className="inline mr-1" /> Mode:{" "}
            {hackathon.mode}
          </div>
          <div className="info-item">
            <Icon name="calendar" size={16} className="inline mr-1" /> Deadline:{" "}
            {hackathon.deadline}
          </div>
          <div className="info-item">
            <Icon name="trophy" size={16} className="inline mr-1" /> Prize Pool:{" "}
            {hackathon.prizePool}
          </div>
        </div>
      </div>
