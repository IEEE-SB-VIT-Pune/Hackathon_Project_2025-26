    ...
    <div className="calendar-list-view">
      ...
      <div className="hackathon-list">
        {hackathons.map((h) => {
          ...
          const start = h.events.find(
            (e) => e.type === "hackathon_start",
          )?.start;
            ...
            <div key={h.name} className="hackathon-card">
              ...
              >
                <div className="hackathon-card-info">
                  <span className="hackathon-card-name">
                ...
                >
                  <span className="hackathon-event-count">
                    {h.events.length} events
                  </span>
                  ...
                  {h.events.map((event, idx) => (
                    ...
                    >
                      ...
                      <div className="tl-body">
                        ...
                        <div className="tl-date">{formatDate(event.start)}</div>
                      </div>
                      <div
                        className={`tl-status ${event.status === "past" ? "past" : "upcoming"}`}
                      >
